...
class MakeupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create makeup" do
    assert_difference("Makeup.count") do
      post makeups_url, params: { makeup: { colour: @makeup.colour, name: @makeup.name, rating: @makeup.rating } }
    end
  ...
  test "should update makeup" do
    patch makeup_url(@makeup), params: { makeup: { colour: @makeup.colour, name: @makeup.name, rating: @makeup.rating } }
